...
import { FindByCustomerIdCustomerService } from './find-by-customer-id-customer.service';
import createdCustomerMock from '@common/mocks/created-customer.mock';

describe('FindByCustomerIdCustomerService', () => {
  let sut: FindByCustomerIdCustomerService;
  ...
  beforeEach(async () => {
    ...
    sut = module.get<FindByCustomerIdCustomerService>(
      FindByCustomerIdCustomerService,
    );
  ...
  it('should be able to find customer by id', async () => {
    jest
      .spyOn(customersRepository, 'findByCustomerId')
